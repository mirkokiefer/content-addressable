...
(function() {
  ...
  ContentAddressable = (function() {
    ...
    ContentAddressable.prototype.write = function(data, cb) {
      ...
      return this.store.write(hash, data, function(err) {
        return cb(err, hash);
      });
    };
    ...
    ContentAddressable.prototype.writeAll = function(data, cb) {
      ...
      return this.store.writeAll(keyValues, function(err) {
        return cb(err, hashs);
      });
    };
  ...
  ContentAddressable.memory = function() {
    return new ContentAddressable({
      store: require('pluggable-store').memory()
    });
  };

  ContentAddressable.fileSystem = function() {
    var args, _ref;
